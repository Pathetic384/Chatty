...
public class Chat implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        addStyle = "send_text";
        try {
            InputStream stream = new FileInputStream("src/main/resources/com/example/chatty/media/ic1.jpg");
            Image image = new Image(stream, 35, 35,false,false);
            icon1 = new ImageView(image);
            InputStream stream2 = new FileInputStream("src/main/resources/com/example/chatty/media/ic2.jpg");
    ...
    public void Call (ActionEvent event) throws IOException {
        Util u = new Util();
        u.newStage(new Stage(),"call.fxml","Calling", "src/main/resources/com/example/chatty/media/call.png" );
    }
